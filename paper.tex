...
The maximization of $\emobjective_{\labelerrprobs}$ w.r.t. $\labelerrprobs$ can be performed using Lagrange multipliers.
\begin{eqnarray*}
  \emobjective_{\labelerrprobs} & = & \sum_{\binlabelindex,\catlabelindex} \labelerrsum_{0,\catlabelindex} \log \labelerrprob_{\binlabelindex,\catlabelindex} \\
